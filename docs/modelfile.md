...
| cache_prompt   | If enabled, the prompt is compared to the previous completion and only the "unseen" suffix is evaluated, optimizing performance by avoiding redundant evaluations. (Default: true)                   | bool     | cache_prompt false            |
